...
- [ ] Retain maintenance protection when sandbox cleanup raises or is interrupted before container removal is confirmed; verify both transient and saved executions.
